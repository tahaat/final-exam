        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">Add Category</h1>
             <div class="btn-group mr-2">
                    <a href="{{url('all/categories')}}" class="btn btn-outline-secondary">All Categories</a>
                </div>
        </div>
            ...
            <div class="card-body">
                <form method="post" action="{{url('update/category').'/' . $category->id}}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="product_name"  value="{{$category->name}}"/>
                    </div>
